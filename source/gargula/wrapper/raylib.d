...
struct VrDeviceInfo
{
    ...
    float hScreenSize = 0; // HMD horizontal size in meters
    float vScreenSize = 0; // HMD vertical size in meters
    float vScreenCenter = 0; // HMD screen center in meters
    float eyeToScreenDistance = 0; // HMD distance between eye and display in meters
    float lensSeparationDistance = 0; // HMD lens separation distance in meters
    float interpupillaryDistance = 0; // HMD IPD (distance between pupils) in meters
    float[4] lensDistortionValues = 0; // HMD lens distortion constant parameters
    float[4] chromaAbCorrection = 0; // HMD chromatic aberration correction parameters
}
